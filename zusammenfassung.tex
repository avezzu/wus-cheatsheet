...
\end{enumerate}
\includegraphics[width = 0.3\textwidth]{assets/prob_interpr_sets.png}
\textbf{Beziehung/Interpretationen zwischen Ereignissen}
\includegraphics[width = 0.3\textwidth]{assets/prob_interpr_two_events.png}
...
\textbf{Bemerkung:} Wir wollen, dass $T$ gerade noch verworfen wird, d.h. insbesondere für den diskreten Fall dass $\left.\mathbb{P}[T \geq t_0]\right|_{t_{0}=T(\omega)}$ 
für $T \sim \text{Binom}(n,\theta_0)$  unter $\mathbb{P}_{\Theta_{0}}$ und $K = [c,n]$.

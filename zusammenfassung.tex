...
$$
Als Konvention setzten wir $R\left(x_{1}, \ldots, x_{n}\right)=+\infty$, falls $L\left(x_{1}, \ldots, x_{n} ; \theta_{0}\right)=0$.\\
...
c_{\neq}=t_{n-1,1-\frac{\alpha}{2}} & \left(-\infty, c_{<}\right) \cup\left(c_{>}, \infty\right) & \mu \neq \mu_{0}
\end{array}
$$
...
Dann analog $z$ und $t$-Test. (Setzt natürliche Paarung von Daten voraus!)\\
